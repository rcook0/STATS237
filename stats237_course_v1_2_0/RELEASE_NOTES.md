...
- Added QMC sampling (Sobol/Halton) with scrambling support.
- Upgraded control variates to multi-control (optimal beta via covariance solve).
- Added variance-reduction diagnostics and convergence report script.
- Added reliability hardening (Black–Scholes tiny-vol limit handling, Hypothesis property tests, determinism tests).
